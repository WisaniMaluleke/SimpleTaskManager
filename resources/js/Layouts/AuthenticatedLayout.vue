...
<SidebarProvider>
    <div class="flex min-h-screen bg-background">
        <!-- Sidebar -->
        <TaskSidebar :activeFilter="filter" @filter-change="setFilter" :class="{ 'hidden sm:block': !sidebarOpen }" />
        ...
        <div class="flex flex-col flex-1 min-h-screen">
            ...
            <nav class="flex items-center justify-between px-6 py-4 shadow-md bg-gradient-header">
                ...
                <div class="flex-1 text-center">
                    ...
                    <SidebarTrigger class="ml-4 text-white hover:bg-white/10" @click="toggleSidebar" />
                </div>
                ...
                <div class="flex items-center justify-end flex-1">
                        ...
                        <Dropdown align="right" width="48">
                            <template #trigger>
                                <button
                                    ...
                                    <svg class="w-4 h-4 ms-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    ...
                    <!-- Mobile Hamburger -->
                    <div class="sm:hidden">
                        <button @click="showingNavigationDropdown.value = !showingNavigationDropdown.value"
            ...
            <!-- Mobile Menu -->
            <div :class="{ block: showingNavigationDropdown.value, hidden: !showingNavigationDropdown.value }"
